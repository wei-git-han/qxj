 ...
 */
public class GwPageUtilsOfxlgl implements Serializable {
	 ...
	 * @param currPage    当前页数
	 */
	public GwPageUtilsOfxlgl(List<?> list, int totalCount, int pageSize, int currPage) {
		this.rows = list;
	...
	public GwPageUtilsOfxlgl(List<?> list,long qyNum,long tyNum){
