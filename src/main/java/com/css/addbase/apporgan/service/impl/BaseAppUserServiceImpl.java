...
public class BaseAppUserServiceImpl implements BaseAppUserService {
	...
	@Override
	public List<Map> queryForUser(String id,String datetime,String txry,String tableId) {
		// TODO Auto-generated method stub
		return baseAppUserDao.queryUsers(id,datetime,txry,tableId);
	}

	@Override
	public int queryUserNum(String id,Date datetime) {
		// TODO Auto-generated method stub
		return baseAppUserDao.queryUserNum(id,datetime);
	}

	@Override
	public int queryNum(String id,Integer i,String datetime,String txry,String tableId) {
		// TODO Auto-generated method stub
		return baseAppUserDao.queryNum(id,i,datetime,txry,tableId);
	}

	@Override
	public BaseAppUser queryByUserId(String userId) {
