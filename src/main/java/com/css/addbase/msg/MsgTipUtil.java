...
public class MsgTipUtil {
	...
	public String sendMsg(String title, String content, String url, String userIds, String appId, String appSecret){
		logger.debug("sendMsg_userIds==================: "+userIds);
