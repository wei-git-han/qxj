...
//	rwgl_wdgz		我的工作		NULL						1		拟制	
	...
	public static String RWGL_WDGZ_MSG_TITLE = "rwgl_wdgz";
	public static String GWCL_SJMHW_MSG_TITLE = "gwcl_sjmhw";
	public static String GWCL_JMHWTG_MSG_TITLE = "gwcl_jmhetg";
	public static String GWCL_JMHWTH_MSG_TITLE = "gwcl_jmheth";
	public static String XLGL_XLTX = "xlgl_xltx";
	/**
	 * 家属从业信息统计消息
	 */
	public static String FAMILY_JOB_INFO = "qscyqkdj";
}
