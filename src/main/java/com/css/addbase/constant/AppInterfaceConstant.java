...
public class AppInterfaceConstant {
     ...
     * @author 王金勇
     * @date 2019年4月18日
     * 公文处理应用调用：我的阅件置顶&取消置顶接口定义
     * */
    public final static String WEB_INTERFACE_DZBMS_TO_GWCL_WDYJ_PLACETOP = "/api/myRead/placeTopOperate";
    /**
     * @author mashuwen
	 * @date 2017年12月03日
...
<<<<<<< HEAD
   ...
   /*  * 获取办件可编最小号的前一个号
     ...
     * 
     */
    public final static String WEB_INTERFACE_GWCL_SYNCHROUPDATE_BANJIAN = "/document/DzbmsBanjian/synchroUpdate";
    /**
     * @author 王金勇
     * @date 2019年06月19日
     * 局间会签：其他局通过该接口传相关表数据，本局用于接收并处理
     * */
    public final static String WEB_INTERFACE_GWCL_COUNTERSIGNATURE_RECEIVEDATAFROMOTHERS = "/app/gwcl/departmentCountsignature/receiveDataFromOthers";
    /**
     * @author 王金勇
     * @date 2019年06月19日
