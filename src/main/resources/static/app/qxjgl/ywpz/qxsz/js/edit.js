var editUrl = {"url":"/app/qxjgl/qxjdicusers/edit","dataType":"text"};
var userTree = {"url":"/app/base/user/tree","dataType":"text"}; //人员选择树
var id = getUrlParam("id");
var userId = getUrlParam("userId");
var userName = getUrlParam2("userName");
...
var pageModule = function(){
	var initother = function(){
		...
		$("#save").click(function(){
			...
			$ajax({
				url:editUrl,
				data:{id:id,username:username,userid:userid,deptid:deptid,rolecode:$("#rolecode").val(),rolename:$("#rolecode").find("option:selected").text()},
				type: "GET",
